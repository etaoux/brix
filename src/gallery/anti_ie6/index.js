/**
 * ie升级提示（手绘版本）
 * @class Brix.Gallery.Anti_ie6
 * @example
 *        
 *        <!--[if lt IE 7]> <script type="text/javascript" src="../../../src/gallery/anti_ie6/index.js"></script> <![endif]-->
 */
                ...
                '<div class="fuck-ie6-update">',
                    ...
                    '<ul id="fieUpdates">',
                        ...
                        '<li><a href="http://download.taobaocdn.com/client/browser/download.php?pid=0080_2010"></a>',
                            ...
                            '<span>下载淘宝浏览器</span>',
                        '</li>',
                        '<li><a target="_blank"  href="http://www.firefox.com.cn/download/"></a>',
                            '<i class="b-firefox"></i>',
                            '<span>下载firefox</span>',
                        '</li>',
